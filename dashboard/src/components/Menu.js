...
//       {/* Flex Column on small screens, row on medium and up */}
...
//         {/* User Info & Logout */}
//         <div className="d-flex align-items-center mt-3 mt-md-0 gap-2 flex-wrap">
...
const Menu = () => {
  ...
  return (
    <div className="menu-container px-3 py-2">
      ...
      {/* Logout for small screens (outside dropdown) */}
